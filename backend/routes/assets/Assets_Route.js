...
} = require("../../controllers/assets/Assets_Controller");
...
router.get("/get/payment_details", getAllPaymentsIn);
// Updating a Total payment In
router.patch("/update/total/payment", updateAgentTotalPaymentIn);
// Deleting a Total payment In
router.delete("/delete/total/payment", deleteAgentPaymentInSchema);
