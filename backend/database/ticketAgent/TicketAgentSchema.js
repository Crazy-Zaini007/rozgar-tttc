...
//Ticket Agent Payment_In Schema
...
//Ticket Agent Payment_Out Schema
...
const TicketAgentsSchema = new mongoose.Schema(
  {
...
const TicketAgents = mongoose.model("ticketAgents", TicketAgentsSchema);
module.exports = TicketAgents
