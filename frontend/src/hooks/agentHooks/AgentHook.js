...
export default function AgentHook() {
    ...
    const getPaymentsIn = async () => {
        try {
            const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/agents/get/payment_in_details', {
                headers: {
    ...
    const getPaymentsOut = async () => {
        try {
            const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/agents/get/payment_out_details', {
                headers: {
