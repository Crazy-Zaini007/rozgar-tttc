...
export default function ProtectorPaymentOut() {
  ...
  const handleForm = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/protectors/add/payment_out', {
        method: 'POST',
        headers: {
                    ...
                    <TableContainer component={Paper}>
                      <Table aria-label="customized table">
                        ...
                        <TableRow>
                          ...
                          <TableCell className='label border'>Total_Protector_Price_In_PKR</TableCell>
                          <TableCell className=' data_td text-center  bg-info text-white text-bold'>{filteredData.total_Protector_Price_Out_PKR}</TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell className='label border'>Total_Protector_Price_In_Curr</TableCell>
                          <TableCell className=' data_td text-center  bg-danger text-white text-bold'>{filteredData.total_Protector_Price_Out_Curr}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          ...
                          <TableCell className=' data_td text-center  bg-success text-white text-bold'>{filteredData.total_Protector_Price_Out_PKR-filteredData.total_Payment_Out}</TableCell>
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell className='label border'>Remaining Total_Payment_Out_Curr</TableCell>
                          <TableCell className=' data_td text-center  bg-danger text-white text-bold'>{filteredData.total_Protector_Price_Out_Curr-filteredData.total_Payment_Out_Curr}</TableCell>
                        </TableRow>
                              </>
                            ))}
