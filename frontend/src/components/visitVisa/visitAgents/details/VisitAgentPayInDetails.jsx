...
export default function VisitAgentPayInDetails() {
    ...
    const { getVisitAgentPaymentsIn } = VisitHook()
    ...
    if (window.confirm('Are you sure you want to delete this record?')){
        ...
        try {
            const response = await fetch(`${apiUrl}/authvisitAgent_Payments_In/agents/delete/single/payment_in`, {
                method: 'DELETE',
                headers: {
    ...
    //Editing for Visit Agent Person 
    ...
    const filteredTotalPaymentIn = visitAgent_Payments_In.filter(payment => {
        return (
  ...
  const filteredIndividualPayments = visitAgent_Payments_In
  ...
  .map((filteredData) => ({
    ...
    const filteredPersons = visitAgent_Payments_In
        .filter((data) => data.supplierName === selectedSupplier)
        .map((filteredData) => ({
            ...filteredData,
...
const changeStatus = async (myStatus) => {
    if (window.confirm(`Are you sure you want to Change the Status of ${selectedSupplier}?`)) {
      ...
      try {
        const response = await fetch(`${apiUrl}/auth/visit/agents/update/payment_in/status`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
            "Authorization": `Bearer ${user.token}`,
  ...
  const printPaymentsTable = () => {
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Visit Agent Payment Invoices</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
  ...
  const printPersonsTable = () => {
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Visit Agent Persons Details</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
  ...
  const formattedDate = formatDate(new Date());
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Visit Agent Payment Invoice</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
  ...
  const printPerson = (person) => {
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Visit Agent Person Details</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
        ...
        <>
            {!option &&
                <>
                    <div className='col-md-12 '>
                        <Paper className='py-3 mb-2 px-2 d-flex justify-content-between'>
                            ...
                            <div className="right d-flex">
                                {visitAgent_Payments_In.length > 0 &&
                                    <>
                    ...
                    {(isLoading && visitAgent_Payments_In.length<1) &&
                            ...
                            <div className="row">
                                <div className="col-auto px-1">
                                    ...
                                    <select value={date1} onChange={(e) => setDate1(e.target.value)} className='m-0 p-1'>
                                        ...
                                        {[...new Set(visitAgent_Payments_In.map(data => data.createdAt))].map(dateValue => (
                                ...
                                <div className="col-auto px-1">
                                    ...
                                    <select value={supplier1} onChange={(e) => setSupplier1(e.target.value)} className='m-0 p-1'>
                                        <option value="">All</option>
                                        {visitAgent_Payments_In && visitAgent_Payments_In.map((data) => (
                    ...
                    {(!isLoading || visitAgent_Payments_In.length>0)&&
                        <div className='col-md-12'>
                ...
                <>
                    ...
                    <div className="col-md-12 my-2">
                        <div className="d-flex justify-content-between supplier_Name">
                            <div className="left d-flex">
                                <h4 className='d-inline '>Visit Agent Name: <span>{selectedSupplier}</span></h4>
                  ...
                  <input type="date" value={dateTo} onChange={(e) => setDateTo(e.target.value)} className='m-0 p-1'/>
                                ...
                                <div className="col-auto px-1">
                                    ...
                                    <select value={payment_Via} onChange={(e) => setPayment_Via(e.target.value)} className='m-0 p-1'>
                                        <option value="">All</option>
                                        {[...new Set(visitAgent_Payments_In
                                            .filter(data => data.supplierName === selectedSupplier)
