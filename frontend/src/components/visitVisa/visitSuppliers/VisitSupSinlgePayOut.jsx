...
export default function VisitSupSinglePayOut() {
  ...
  const handleForm = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/visit/suppliers/add/payment_out', {
        method: 'POST',
        headers: {
  ...
  const handleUploadList =async (e) => {
    ...
    e.preventDefault()
    try {
      const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/visit/suppliers/add/multiple/payment_out', {
        method: "POST",
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${user.token}`,
                    ...
                    {visitSupplier_Payments_Out
                      ...
                      .map((filteredData) => (
                        ...
                        <TableRow>
                          ...
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell className='label border'>Total_VisitVisa_Price_Out_PKR</TableCell>
                          ...
                          <TableCell></TableCell>
                          <TableCell></TableCell>
                          <TableCell className='label border'>Total_VisitVisa_Price_Out_Curr</TableCell>
