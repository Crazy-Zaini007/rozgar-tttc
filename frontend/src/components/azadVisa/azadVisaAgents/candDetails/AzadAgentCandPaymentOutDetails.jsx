...
export default function AzadAgentCandPaymentOutDetails() {
  ...
  const deletePaymentIn = async (payment) => {
    if (window.confirm('Are you sure you want to delete this record?')) {
      ...
      try {
        const response = await fetch(`${apiUrl}/auth/azadVisa/agents/delete/cand_vise/payment_out`, {
          method: 'DELETE',
          headers: {
  ...
  const deleteSinglePaymentIn = async (payment) => {
    if (window.confirm('Are you sure you want to delete this record?')) {
      ...
      try {
        const response = await fetch(`${apiUrl}/auth/azadVisa/agents/delete/cand_vise/single/payment_out`, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
            "Authorization": `Bearer ${user.token}`,
  ...
  const deletePerson = async (person) => {
    if (window.confirm('Are you sure you want to delete this record?')) {
      ...
      try {
        const response = await fetch(`${apiUrl}/auth/azadVisa/agents/delete/person/payment_out`, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
            "Authorization": `Bearer ${user.token}`,
  ...
  const handleUpdatePerson = async () => {
    setLoading4(true)
    try {
      const response = await fetch(`${apiUrl}/auth/azadVisa/agents/payment_out/update/single/person`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          "Authorization": `Bearer ${user.token}`,
  ...
  const handleUpdate = async () => {
    ...
    let paymentId = details._id
    try {
      const response = await fetch(`${apiUrl}/auth/azadVisa/agents/update/cand_vise/single/payment_out`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          "Authorization": `Bearer ${user.token}`,
  ...
  const handleTotalPaymentUpdate = async () => {
    setLoading3(true)
    try {
      const response = await fetch(`${apiUrl}/auth/azadVisa/agents/update/all/payment_out`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          "Authorization": `Bearer ${user.token}`,
        },
        body: JSON.stringify({ supplierName: editedEntry1.supplierName, total_Payment_Out: editedEntry1.total_Payment_Out, total_Cash_Out: editedEntry1.total_Cash_Out, total_Azad_Visa_Price_Out_Curr: editedEntry1.total_Payment_Out_Curr, open: editedEntry1.open, close: editedEntry1.close })
      })
  ...
  const deleteTotalpayment = async (person) => {
    if (window.confirm('Are you sure you want to delete this record?')) {
      ...
      try {
        const response = await fetch(`${apiUrl}/auth/azadVisa/agents/delete/all/payment_out`, {
          method: 'DELETE',
          headers: {
            'Content-Type': 'application/json',
            "Authorization": `Bearer ${user.token}`,
    ...
    <table class='print-table'>
      ...
      entry.persons.map((person, personIndex) => `
          <tr key="${person?._id}">
            ...
            <td>${String(person?.visa_Price_Out_PKR) - String(person?.total_In) + String(person?.cash_Out)}</td>
  ...
  const downloadExcel = () => {
    ...
    filteredTotalPaymentIn.forEach((payments, index) => {
      const rowData = {
        ...
        Total_Azad_Visa_Price_In_PKR: payments.total_Azad_Visa_Price_Out_PKR,
        ...
        Total_Azad_Visa_Price_In_Curr: payments.total_Azad_Visa_Price_Out_Curr,
        Total_Payment_In_Curr: payments.total_Payment_Out_Curr,
...
// Editing for single Payment In 
 ...
 const handleUpdatePayment = async () => {
  ...
  try {
    const response = await fetch(`${apiUrl}/auth/azadVisa/agents/update/cand_vise/payment_out`, {
      method: 'PATCH',
      headers: {
        'Content-Type': 'application/json',
        "Authorization": `Bearer ${user.token}`,
          ...
          <div className='col-md-12 '>
            <Paper className='py-3 mb-2 px-2 d-flex justify-content-between'>
              <div className="left d-flex">
                <h4>Azad Agent Cand-Vise PaymentOut Details</h4>
              </div>
              <div className="right d-flex">
                {azadAgent_Payments_Out.length > 0 &&
                  <>
                            ...
                            <TableRow key={entry?._id} className={outerIndex % 2 === 0 ? 'bg_white' : 'bg_dark'} >
                              {editMode1 && editedRowIndex1 === outerIndex ? (
                                ...
                                <>
                                  ...
                                  <TableCell className='border data_td p-1 '>
                                    <input type='number' min='0' value={editedEntry1.total_Azad_Visa_Price_Out_PKR} onChange={(e) => handleTotalPaymentInputChange(e, 'total_Azad_Visa_Price_Out_PKR')} readonly />
                                  </TableCell>
                                  <TableCell className='border data_td p-1 '>
                                  ...
                                  <TableCell className='border data_td p-1 '>
                                    <input type='number' value={editedEntry1.total_Azad_Visa_Price_Out_PKR - editedEntry1.total_Payment_Out + editedEntry1.total_Cash_Out} readonly />
                                  </TableCell>
                                  <TableCell className='border data_td p-1 '>
                                    <input type='number' min='0' value={editedEntry1.total_Azad_Visa_Price_Out_Curr} onChange={(e) => handleTotalPaymentInputChange(e, 'total_Azad_Visa_Price_Out_Curr')} readonly />
                                  </TableCell>
                                  <TableCell className='border data_td p-1 '>
                                  ...
                                  <TableCell className='border data_td p-1 '>
                                    <input type='number' min='0' value={editedEntry1.total_Azad_Visa_Price_Out_Curr - editedEntry1.total_Payment_Out_Curr} onChange={(e) => handleTotalPaymentInputChange(e, 'remaining_Curr')} readonly />
                                  </TableCell>
                      ...
                      <TableRow>
                        ...
                        <TableCell className='border data_td text-center bg-warning text-white'>
                          ...
                          {filteredTotalPaymentIn.reduce((total, paymentItem) => {
                            ...
                            // Add the difference between total_Azad_Visa_Price_Out_PKR and total_Payment_Out, then add total_Cash_Out
            ...
            <TableContainer component={Paper} sx={{ maxHeight: 600 }}>
              ...
              <TableHead className="thead">
                  <TableRow>
                    ...
                    <TableCell className='label border' style={{ width: '18.28%' }}>Total_Azad_Visa_Price_PKR</TableCell>
