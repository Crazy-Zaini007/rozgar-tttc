...
export default function AzadVisaAgentPayOutDetails() {
    ...
    if (window.confirm('Are you sure you want to delete this record?')){
        ...
        try {
            const response = await fetch(`${apiUrl}/auth/azadVisa/agents/delete/single/payment_out`, {
                method: 'DELETE',
                headers: {
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await fetch(`${apiUrl}/auth/azadVisa/agents/update/single/payment_out`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    "Authorization": `Bearer ${user.token}`,
        ...
        <>
            {!option &&
                <>
                    ...
                    {(isLoading && azadAgent_Payments_Out.length<1) &&
                    ...
                    {(!isLoading || azadAgent_Payments_Out.length>0) &&
                        <div className='col-md-12'>
                                ...
                                <TableContainer sx={{ maxHeight: 600 }}>
                                    <Table stickyHeader>
                                        <TableHead>
                                            ...
                                            <TableCell className='label border' >Total Azad Visa Price PKR</TableCell>
