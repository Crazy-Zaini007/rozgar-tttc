...
export default function AzadVisaCandPaymentOutDetails() {
  ...
  const {  getAzadCandPaymentsOut } = AzadVisaHook()
 ...
 return false;
  ...
  const filteredIndividualPayments = azadCand_Payments_Out
    ...
    <>
      {!option &&
        <>
          <div className='col-md-12 '>
            <Paper className='py-3 mb-2 px-2 d-flex justify-content-between'>
              ...
              <div className="right d-flex">
                {azadCand_Payments_Out.length > 0 &&
                  <>
          ...
          {(isLoading && azadCand_Payments_Out.length<1) &&
