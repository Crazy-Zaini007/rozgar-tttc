...
export default function AzadVisaCandPayOutReturn() {
  ...
  const handleForm = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/azadVisa/candidates/payment_in/cash_out', {
        method: 'POST',
        headers: {
