...
export default function AzadVisaSupPayOutReturn() {
  ...
  const handleForm = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/azadVisa/suppliers/payment_out/cash_out', {
        method: 'POST',
        headers: {
