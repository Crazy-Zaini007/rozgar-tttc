...
export default function AzadVisaSupPayInDetails() {
    ...
    const { getAzadSupplierPaymentsIn } = AzadVisaHook()
    ...
    if (window.confirm('Are you sure you want to delete this record?')){
        ...
        try {
            const response = await fetch(`${apiUrl}/auth/azadVisa/suppliers/delete/single/payment_in`, {
                method: 'DELETE',
                headers: {
    ...
    if (window.confirm('Are you sure you want to delete this record?')){
        ...
        try {
            const response = await fetch(`${apiUrl}/auth/azadVisa/suppliers/delete/person/payment_in`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    "Authorization": `Bearer ${user.token}`,
    ...
    const handleUpdatePerson = async () => {
        setLoading5(true)
        try {
            const response = await fetch(`${apiUrl}/auth/azadVisa/suppliers/payment_in/update/single/person`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    "Authorization": `Bearer ${user.token}`,
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await fetch(`${apiUrl}/auth/azadVisa/suppliers/update/single/payment_in`, {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    "Authorization": `Bearer ${user.token}`,
    ...
    if (window.confirm('Are you sure you want to delete this record?')){
        setLoading5(true)
        try {
            const response = await fetch(`${apiUrl}/auth/azadVisa/suppliers/delete/all/payment_in`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    "Authorization": `Bearer ${user.token}`,
    ...
    const filteredTotalPaymentIn = azadSupplier_Payments_In.filter(payment => {
        return (
  ...
  const filteredIndividualPayments = azadSupplier_Payments_In
  ...
  .map((filteredData) => ({
    ...
    const filteredPersons = azadSupplier_Payments_In
        .filter((data) => data.supplierName === selectedSupplier)
        .map((filteredData) => ({
            ...filteredData,
        ...
        <>
            {!option &&
                <>
                    <div className='col-md-12 '>
                        <Paper className='py-3 mb-2 px-2 d-flex justify-content-between'>
                            ...
                            <div className="right d-flex">
                                {azadSupplier_Payments_In.length > 0 &&
                                    <>
                    ...
                    {(isLoading && azadSupplier_Payments_In.lenght<1) &&
                            ...
                            <div className="row">
                                <div className="col-auto px-1">
                                    ...
                                    <select value={date1} onChange={(e) => setDate1(e.target.value)} className='m-0 p-1'>
                                        ...
                                        {[...new Set(azadSupplier_Payments_In.map(data => data.createdAt))].map(dateValue => (
                                ...
                                <div className="col-auto px-1">
                                    ...
                                    <select value={supplier1} onChange={(e) => setSupplier1(e.target.value)} className='m-0 p-1'>
                                        <option value="">All</option>
                                        {azadSupplier_Payments_In && azadSupplier_Payments_In.map((data) => (
                    ...
                    {(!isLoading || azadSupplier_Payments_In.lenght>0) &&
                        <div className='col-md-12'>
                  ...
                  <input type="date" value={dateTo} onChange={(e) => setDateTo(e.target.value)} className='m-0 p-1'/>
                                ...
                                <div className="col-auto px-1">
                                    ...
                                    <select value={payment_Via} onChange={(e) => setPayment_Via(e.target.value)} className='m-0 p-1'>
                                        <option value="">All</option>
                                        {[...new Set(azadSupplier_Payments_In
                                            .filter(data => data.supplierName === selectedSupplier)
                            ...
                            <Table stickyHeader>
                                <TableHead className="thead">
                                    <TableRow>
                                        ...
                                        {show === true && <TableCell className='label border' >Azad Visa Price In PKR Oth Curr</TableCell>}
                                        <TableCell className='label border'>Status</TableCell>
