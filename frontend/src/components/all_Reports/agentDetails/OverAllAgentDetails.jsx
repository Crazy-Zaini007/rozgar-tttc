...
import AgentPaymentInDetails from './details/AgentPaymentInDetails'
import AgentPaymentOutDetails from './details/AgentPaymentOutDetails'
export default function OverAllAgentDetails() {
      ...
      <div className="main">
        <div className="container-fluid py-2 payment_details">
          <div className="row">
            ...
            {option === 0 && 
              <AgentPaymentInDetails></AgentPaymentInDetails>
            }
            {option === 1 &&
              <AgentPaymentOutDetails></AgentPaymentOutDetails>
            }
