...
export default function TicketAgentReports() {
  ...
  const getData = async () => {
    ...
    try {
      const response = await fetch(`${apiUrl}/auth/reports/get/ticket/agents/reports`, {
        headers: {
            ...
            <div className='col-md-12 '>
              <Paper className='py-3 mb-2 px-2 d-flex justify-content-between'>
                <div className="left d-flex">
                  <h4>Ticket Agents Payments Reports</h4>
                </div>
