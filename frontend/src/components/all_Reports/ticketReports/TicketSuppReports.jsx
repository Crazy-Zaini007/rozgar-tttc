...
export default function TicketSuppReports() {
  ...
  const getData = async () => {
    ...
    try {
      const response = await fetch(`${apiUrl}/auth/reports/get/ticket/suppliers/reports`, {
        headers: {
            ...
            <div className='col-md-12 p-0 border-0 border-bottom'>
              <div className='py-2 mb-2 px-2 d-flex justify-content-between'>
                <div className="left d-flex">
                  <h4>Ticket Suppliers Payments Reports</h4>
                </div>
