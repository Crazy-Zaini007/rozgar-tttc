...
export default function LoseReport() {
  ...
  return (
    ...
    <div className={`${collapsed ?"collapsed":"main"}`}>
        <div className="container-fluid payment_details mt-3">
          ...
          {!isLoading && 
          <div className="col-sm-12 p-0 detail_table my-2">
          <TableContainer >
            <Table stickyHeader>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className='border data_td text-center loss text-white' >
                  ...
                  <TableCell className='border data_td text-center text-white bg-danger' >
                  Net_Loss: 
