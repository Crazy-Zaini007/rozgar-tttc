...
import SupPaymentInDetails from './details/SupPaymentInDetails'
import SupPaymentOutDetails from './details/SupPaymentOutDetails'
export default function OverAllSupDetails() {
      ...
      <div className="main">
        <div className="container-fluid py-2 payment_details">
          <div className="row">
            ...
            {option === 0 &&
              <SupPaymentInDetails></SupPaymentInDetails>
            }
            {option === 1 &&
              <SupPaymentOutDetails></SupPaymentOutDetails>
            }
