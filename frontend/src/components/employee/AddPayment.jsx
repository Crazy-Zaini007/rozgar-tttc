...
export default function AddPayment() {
  ...
  const [multiplePayment, setMultiplePayment] = useState([{date:'', employeeName: '', month: '', category: '', payment_Via: '', payment_Type: '',slip_No:'', payment_Out: 0, details: '', curr_Country: '', curr_Rate: 0, curr_Amount: 0 }])
