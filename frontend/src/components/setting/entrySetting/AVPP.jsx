...
import { addAzadVisaPurchaseParty } from '../../../redux/reducers/settingSlice';
  ...
  const addSuppliers = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        dispatch(addAzadVisaPurchaseParty(json.data)); // Dispatch the action with received data
        setSupplerName('')
        setSupplierCompany('')
        setContact('')
        setCountry('')
  ...
  return (
    <>
      <div className="col-md-12 adding_form">
        <h5>Azad Visa Purchase Parties</h5>
        <form className='px-2 py-3 rounded' onSubmit={addSuppliers}>
          <div className="row">
            ...
            {picture && <div className="col-lg-3 col-md-12 col-sm-12 mb-3">
              <div className="image">
                <img src={picture} alt="" className='rounded' required />
              </div>
            </div>}
          </div>
      ...
      <div className="col-md-12 details_table mt-4">
        ...
        <TableContainer component={Paper}>
          <Table>
            ...
            <TableBody>
              {azadVisaPurchaseParties && azadVisaPurchaseParties.length > 0 ? azadVisaPurchaseParties.map((data,index)=>(
