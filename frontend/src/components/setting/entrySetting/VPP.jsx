...
import { addVisaPurchaseParty } from '../../../redux/reducers/settingSlice';
  ...
  const addSuppliers = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        dispatch(addVisaPurchaseParty(json.data)); // Dispatch the action with received data
        setSupplerName('')
        setSupplierCompany('')
        setContact('')
        setCountry('')
  ...
  return (
    <>
      <div className="col-md-12 adding_form">
        <h5>Visa Purchase Parties </h5>
        <form className='px-2 py-3 rounded' onSubmit={addSuppliers}>
          <div className="row">
            <div className="col-lg-3 col-md-6 col-s2 mb-3">
            ...
            {picture && <div className="col-lg-3 col-md-12 col-s2 mb-3">
              <div className="image">
      ...
      <div className="col-md-12 details_table mt-4">
        ...
        <TableContainer component={Paper}>
          <Table>
            ...
            <TableBody>
              {visaPurchaseParty && visaPurchaseParty.length > 0 ? visaPurchaseParty.map((data,index)=>(
