...
import { addTicketSalesParty } from '../../../redux/reducers/settingSlice';
  ...
  const addSuppliers = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        dispatch(addTicketSalesParty(json.data)); // Dispatch the action with received data
        setSupplerName('')
        setSupplierCompany('')
        setContact('')
        setCountry('')
      ...
      <div className="col-md-12 details_table mt-4">
        ...
        <TableContainer component={Paper}>
          <Table>
            ...
            <TableBody>
              {ticketSalesParties && ticketSalesParties.length > 0 ? ticketSalesParties.map((data,index)=>(
