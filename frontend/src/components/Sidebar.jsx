      ...
      switch (route) {
        ...
        case '/rozgar/reports/payroll_reports':
          ...
          case '/rozgar/reports/net_visa_reports':
            ...
            break;
            case '/rozgar/reports/cand_visa_payment_in_reports':
              setActiveItem(112)
              setOption1(false)
              setOption2(false)
              setOption3(false)
              ...
              case '/rozgar/reports/cand_visa_payment_out_reports':
                setActiveItem(119)
                setOption1(false)
                setOption2(false)
                setOption3(false)
              ...
              break;
              case '/rozgar/reports/direct_payment_in_reports':
              setActiveItem(116)
              setOption1(false)
              setOption2(false)
              setOption3(false)
              ...
              break;
              case '/rozgar/reports/direct_payment_out_reports':
              setActiveItem(117)
              setOption1(false)
              setOption2(false)
              setOption3(false)
              ...
              break;
              case '/rozgar/reports/overall_combine_payment_in_reports':
                setActiveItem(115)
                setOption1(false)
                setOption2(false)
                setOption3(false)
                ...
                case '/rozgar/reports/overall_combine_payment_out_reports':
                setActiveItem(118)
                setOption1(false)
                setOption2(false)
                setOption3(false)
          ...
          <ul className="mt-2">
            ...
            {option4 &&
              <>
                ...
                <li className=' my-2' style={activeItem === 17 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(17, `/rozgar/setting/crediter_debiter_section`)}><i className="fa-solid fa-circle-dot mx-2"></i>Credit/Debite Section</li>
          ...
          <ul className="mt-2">
            ...
            {option12 &&
              <>
                ...
                <li className=' my-2' style={activeItem === 71 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(71, `/rozgar/reports/overall_visa_wise`)}><i className="fa-solid fa-circle-dot mx-2"></i>Overall Visa Profit</li>
                <li className=' my-2' style={activeItem === 72 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(72, `/rozgar/reports/overall_payment_visa_wise`)}><i className="fa-solid fa-circle-dot mx-2"></i>Overall Payment <br /> <span className='ms-4'> Visa Vise</span></li>
                ...
                <li className=' my-2' style={activeItem === 112 ?{ backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(112, `/rozgar/reports/cand_visa_payment_in_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Candidate Vise  <br /> <span className='ms-4'> Payment In Reports</span></li>
                <li className=' my-2' style={activeItem === 119 ?{ backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(119, `/rozgar/reports/cand_visa_payment_out_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Candidate Vise  <br /> <span className='ms-4'> Payment Out Reports</span></li>
                <li className=' my-2' style={activeItem === 116 ?{ backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(116, `/rozgar/reports/direct_payment_in_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Direct Payment In  <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 117 ?{ backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(117, `/rozgar/reports/direct_payment_out_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Direct Payment Out  <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 115 ?{ backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(115, `/rozgar/reports/overall_combine_payment_in_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Combined Payment <br /> <span className='ms-4'> In Reports</span></li>
                <li className=' my-2' style={activeItem === 118 ?{ backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(118, `/rozgar/reports/overall_combine_payment_out_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Combined Payment <br /> <span className='ms-4'> Out Reports</span></li>
                <li className=' my-2' style={activeItem === 77 ?{ backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(77, `/rozgar/reports/candidates_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Candidate Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 78 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(78, `/rozgar/reports/agents_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Agents Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 79 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(79, `/rozgar/reports/suppliers_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Suppliers Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 100 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(100, `/rozgar/reports/ticket_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Ticket Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 101 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(101, `/rozgar/reports/azadVisa_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>AzadVisa Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 102 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(102, `/rozgar/reports/visitVisa_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>VisitVisa Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 73 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(73, `/rozgar/reports/receivable_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Receivable Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 74 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(74, `/rozgar/reports/payable_reports`)}><i className="fa-solid fa-circle-dot mx-2"></i>Payable Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 97 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(97, `/rozgar/reports/normal_payments`)}><i className="fa-solid fa-circle-dot mx-2"></i>Normal Payment <br /> <span className='ms-4'> Reports</span></li>
                <li className=' my-2' style={activeItem === 98 ? { backgroundColor: 'var(--accent-stonger-blue)', border: '0px', borderRadius: '4px', fontWeight: '600', color: 'var(--white)', transition: 'background-color 0.3s', transform: '0.3s' } : {}} onClick={() => handleItemClick(98, `/rozgar/reports/advance_payments`)}><i className="fa-solid fa-circle-dot mx-2"></i>Advance Payment <br /> <span className='ms-4'> Reports</span></li>
