...
export default function CandPaymentInDetails() {
...
return false;
  ...
  const filteredIndividualPayments = candidate_Payments_In
                  ...
                  <div className="row">
                    <div className="col-auto px-1">
                      ...
                      <select value={date1} onChange={(e) => setDate1(e.target.value)} className='m-0 p-1'>
                        ...
                        {[...new Set(candidate_Payments_In.map(data => data.createdAt))].map(dateValue => (
                                ...
                                <TableRow key={entry?._id} className={outerIndex % 2 === 0 ? 'bg_white' : 'bg_dark'} >
                                  {editMode1 && editedRowIndex1 === outerIndex ? (
                                    ...
                                    <>
                                      ...
                                      <TableCell className='border data_td text-center' onClick={() => {handleRowClick(entry.supplierName); handleCandidate(entry)}}>
                                        {entry.supplierName}
                                      </TableCell>
                                      <TableCell className='border data_td text-center'>
                                        {entry.pp_No}
