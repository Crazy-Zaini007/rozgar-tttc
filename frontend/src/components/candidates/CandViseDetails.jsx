...
import CandVisePaymentInDetails from './candDetails/CandVisePaymentInDetails'
import CandVisePaymentOutDetails from './candDetails/CandVisePaymentOutDetails'
export default function CandViseDetails() {
      ...
      <div className="main">
        <div className="container-fluid py-2 payment_details">
          <div className="row">
            ...
            {option === 0 && 
              <CandVisePaymentInDetails></CandVisePaymentInDetails>
            }
            {option === 1 &&
              <CandVisePaymentOutDetails></CandVisePaymentOutDetails>
            }
