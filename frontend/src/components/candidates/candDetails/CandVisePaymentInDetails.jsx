...
export default function CandVisePaymentInDetails() {
  ...
  const downloadExcel = () => {
    ...
    candidate_Payments_In.forEach((payments, index) => {
      const rowData = {
        SN: index + 1,
                            ...
                            <TableRow key={entry?._id} className={outerIndex % 2 === 0 ? 'bg_white' : 'bg_dark'} >
                              {editMode1 && editedRowIndex1 === outerIndex ? (
                                ...
                                <>
                                  ...
                                  <TableCell className='border data_td p-1 '>
                                    <input type='text'  value={editedEntry1.pp_No} onChange={(e) => handleTotalPaymentInputChange(e, 'pp_No')} readonly />
                                  </TableCell>
                                  <TableCell className='border data_td p-1 '>
