...
export default function CandVisePaymentOut() {
  ...
  const handleForm = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('/auth/candidates/add/payment_out', {
        method: 'POST',
        headers: {
  ...
  const [formData, setFormData] = useState([{ Name: '', Category: '', Payment_Via: '', Payment_Type: '', Slip_No: '', Payment_Out: '', Details: '', CUR_Country: '', CUR_Rate: '', Currency_Amount: '' ,cand_Name:''}])
                  ...
                  {!option && <TableContainer component={Paper}>
                    <form className='py-3 px-2' onSubmit={handleForm}>
                     ...
                     <div className="col-xl-2 col-lg-3 col-md-6 col-sm-12 p-1 my-1">
                          ...
                          <input type="text" value={cand_Name} onChange={(e) => setCand_Name(e.target.value)} required />
                       </div>
