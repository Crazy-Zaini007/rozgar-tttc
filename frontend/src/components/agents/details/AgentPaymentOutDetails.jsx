                  ...
                  <Table stickyHeader>
                    <TableHead>
                      ...
                      <TableRow>
                        ...
                        <TableCell className='label border' style={{ width: '18.28%' }}>TVPO_PKR</TableCell>
                        ...
                        <TableCell className='label border' style={{ width: '18.28%' }}>RPO_PKR</TableCell>
                        {show1 && <>
                                ...
                                <>
                                  ...
                                  <TableCell className='border data_td p-1 '>
                                    <div className="btn-group" role="group" aria-label="Basic mixed styles example">
                                      ...
                                      <button className='btn delete_btn' onClick={() => deleteTotalpayment(entry)} disabled={loading5}><i className="fa-solid fa-trash-can"></i></button>
                                    </div>
