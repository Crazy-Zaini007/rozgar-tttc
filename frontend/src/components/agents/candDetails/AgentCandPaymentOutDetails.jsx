              ...
              <Table stickyHeader>
                <TableHead className="thead">
                  <TableRow>
                    ...
                    <TableCell className='label border' >Total_Out_PKR</TableCell>
                    <TableCell className='label border' >Total_Cash_Out</TableCell>
              ...
              <Table stickyHeader>
                <TableHead className="thead">
                  <TableRow>
                    ...
                    <TableCell className='label border'>New_Payment_Out_PKR</TableCell>
                    {show2 && 
                       <>
                    ...
                    <TableCell className='label border'>New_Payment_Out_Curr</TableCell>
