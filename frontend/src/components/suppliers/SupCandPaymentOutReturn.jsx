...
export default function SupCandPaymentOutReturn() {
...
let totalCurrency=(totalPayments/totalCurrRate).toFixed(2)
  ...
  const handleForm = async (e) => {
    ...
    setTotalPayments('')
    try {
      const response = await fetch(`${apiUrl}/auth/suppliers/add/cand_vise/payment_out/cash_out`, {
        method: "POST",
        headers: {
