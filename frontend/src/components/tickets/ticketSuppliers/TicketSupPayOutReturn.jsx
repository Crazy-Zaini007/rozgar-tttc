...
export default function TicketSuptPayOutReturn() {
  ...
  const handleForm = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://api-rozgar-tttc.onrender.com/auth/ticket/suppliers/payment_out/cash_out', {
        method: 'POST',
        headers: {
