...
const changeStatus = async (myStatus) => {
  ...
  const printPaymentsTable = () => {
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Ticket Supplier Payment Invoices</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
  ...
  const printPersonsTable = () => {
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Ticket Supplier Persons Details</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
  ...
  const formattedDate = formatDate(new Date());
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Ticket Supplier Payment Invoice</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
  ...
  const printPerson = (person) => {
    ...
    const printContentString = `
      ...
      <div class="print-header">
        <h1 class="title">Ticket Supplier Person Details</h1>
      </div>
      <hr/>
      <table class='print-table'>
        <thead>
        ...
        <>
            {!option &&
                <>
                    ...
                    {(isLoading && ticketSupplier_Payments_In.lenght<1) &&
                    ...
                    {(!isLoading || ticketSupplier_Payments_In.lenght>0) &&
                        <div className='col-md-12'>
                            ...
                            <Table stickyHeader>
                                <TableHead className="thead">
                                    <TableRow>
                                        ...
                                        {show === true && <TableCell className='label border' >Ticket Visa Price In PKR Oth Curr</TableCell>}
                                        <TableCell className='label border'>Status</TableCell>
