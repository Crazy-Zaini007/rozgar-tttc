...
import TicketPayInDetails from './TicketPayInDetails'
import TicketPayOutDetails from './TicketPayOutDetails'
    ...
    <div className={`${collapsed ?"collapsed":"main"}`}>
        <div className="container-fluid py-2 payment_details">
          <div className="row">
            ...
            {option === 0 && 
              <TicketPayInDetails></TicketPayInDetails>
            }
            {option === 1 &&
              <TicketPayOutDetails></TicketPayOutDetails>
            }
