...
import TicketSupPayInReturn from './ticketSuppliers/TicketSupPayInReturn'
import TicketAgentPayInReturn from './ticketAgents/TicketAgentPayInReturn'
import TicketCandPayInReturn from './ticketCandidates/TicketCandPayInReturn'

export default function TicketPayInReturn() {
    ...
    <>
      ...
      <div className="col-md-12 ">
         <Paper className='py-3 mb-1 px-2'>
                <h4>Ticket Section Payment In Return</h4>
          ...
          {section === 0 &&
              <TicketSupPayInReturn></TicketSupPayInReturn>
          }
           {section === 1 &&
              <TicketAgentPayInReturn></TicketAgentPayInReturn>
          }
           {section === 2 &&
              <TicketCandPayInReturn></TicketCandPayInReturn>
          }
    </>
  )
}
