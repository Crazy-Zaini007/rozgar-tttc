...
export default function PaymentOutDetails() {
  ...
  const downloadExcel = () => {
    ...
    CDWOC_Payments_Out.forEach((payments, index) => {
      const rowData = {
        SN: index + 1,
    ...
    XLSX.writeFile(wb, 'CDWOC_Payments_Out.xlsx');
  };
    ...
    <>
            ...
            <Paper className='py-3 mb-1 px-2 detail_table'>
              <TableContainer sx={{ maxHeight: 600 }}>
                <Table stickyHeader>
                  ...
                  <TableBody>
                    {CDWOC_Payments_Out.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((entry, index) => (
              ...
              <TablePagination
                ...
                component='div'
                count={CDWOC_Payments_Out.length}
      ...
      {option && selectedSupplier && (
        <>
          ...
          {CDWOC_Payments_Out.reduce((total, filteredData) => {
